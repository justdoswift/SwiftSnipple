...
> Historical note: this archived roadmap includes earlier frontend-stack assumptions. Treat any `SvelteKit` or `shadcn-svelte` references here as historical record only.
